...
const toggleCommentLike = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(
      500,
      error,
      "Some error occurred while toggling comment like: Try again later"
    );
  }
}); //DONE!
...
const toggleTweetLike = asyncHandler(async (req, res) => {
  ...
  if (!isValidObjectId(tweetId)) {
    throw new ApiError(
      404,
      "Invalid tweetId provided: Provide a valid tweet id"
    );
  }
  ...
  try {
    ...
    throw new ApiError(
      500,
      error,
      "Some error occurred while toggling tweet like: Try again later"
    );
  }
}); //DONE!
